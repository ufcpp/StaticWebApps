...
{
    public static IEnumerable<Operation> InPlaceMergeSort(int[] arr) => InPlaceMergeSort(arr, 0, arr.Length - 1);
    ...
    private static IEnumerable<Operation> InPlaceMergeSort(int[] arr, int l, int r)
    {
        if (l < r)
        {
            ...
            foreach (var x in InPlaceMergeSort(arr, m + 1, r)) yield return x;
